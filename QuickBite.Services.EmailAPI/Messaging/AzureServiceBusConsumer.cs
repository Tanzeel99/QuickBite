...
namespace QuickBite.Services.EmailAPI.Messaging
{
    public class AzureServiceBusConsumer : IAzureServiceBusConsumer
    {
        ...
        private readonly EmailService _emailService;//directly emailservice not iemailservice because of singleton
        ...
        public AzureServiceBusConsumer(IConfiguration configuration, EmailService emailService)
        {
            ...
            _emailCartProcessor = client.CreateProcessor(emailCartQueue); //To listen from queue
